		...
		*/
		...
		page.items.timer = function(){
			...
			while(i--){
				...
				page.items.sectionTimer.find('label').eq(i).html((page.items.timerVal[i] < 9 ? '0' + page.items.timerVal[i] : page.items.timerVal[i]));
			...
			*/
			...
			page.items.timerVal = [
				(page.items.timerVal[1] >= o ? (+page.items.timerVal[0]+1) : page.items.timerVal[0]),
				(page.items.timerVal[1] >= o ? 0 : (+page.items.timerVal[1]+1)),
			];
					...
					if(m){
						...
						*/
						...
						if(page.items.deck.find('li.match').length >= page.items.symbols.length*2){
							...
							James here are the values...
							Use them as you please!

							*/

							// Number of visable stars...
							console.log(page.items.body.find('ul.stars li:visible').length);

							// time elapsed...

							// mins
							console.log(page.items.timerVal[0])
							//seconds
							console.log(page.items.timerVal[1])
							// both...
							console.log(page.items.timerVal[0] + ':' + page.items.timerVal[1])

							alert('Well done, You have won the game in ' + page.items.moves + ' moves... and in a time of ' + page.items.timerVal[0]  + ':' + page.items.timerVal[1] + ' with a star rating of ' + page.items.body.find('ul.stars li:visible').length +'... click restart to play again!!');
